...
var DynamoDBDataLoader = /** @class */ (function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [3 /*break*/, 18];
          case 1:
            return [4 /*yield*/, this.getItem(payload)];
          case 2:
            return [2 /*return*/, _b.sent()];
          case 3:
            return [4 /*yield*/, this.putItem(payload)];
          case 4:
            return [2 /*return*/, _b.sent()];
          case 5:
            return [4 /*yield*/, this.updateItem(payload)];
          case 6:
            return [2 /*return*/, _b.sent()];
          case 7:
            return [4 /*yield*/, this.deleteItem(payload)];
          case 8:
            return [2 /*return*/, _b.sent()];
          case 9:
            return [4 /*yield*/, this.query(payload)];
          case 10:
            return [2 /*return*/, _b.sent()];
          case 11:
            return [4 /*yield*/, this.scan(payload)];
          case 12:
            return [2 /*return*/, _b.sent()];
          case 13:
            return [4 /*yield*/, this.transactWriteItem(payload)];
          case 14:
            return [2 /*return*/, _b.sent()];
          case 15:
            return [4 /*yield*/, this.transactGetItem(payload)];
          case 16:
            return [2 /*return*/, _b.sent()];
          case 17:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            result = _b.sent();
            if (!result.Item) return [2 /*return*/, null];
        ...
        switch (_f.label) {
          case 0:
            (key = payload.key),
              ...
              (_a = payload.condition),
              (_b = _a === void 0 ? {} : _a),
              (_c = _b.expression),
              (expression = _c === void 0 ? null : _c),
              (_d = _b.expressionNames),
              (expressionNames = _d === void 0 ? null : _d),
              (_e = _b.expressionValues),
              (expressionValues = _e === void 0 ? null : _e);
            return [
              4 /*yield*/,
              this.client
                .putItem({
  ...
  DynamoDBDataLoader.prototype.query = function (_a) {
    var keyCondition = _a.query,
      filter = _a.filter,
      index = _a.index,
      nextToken = _a.nextToken,
      limit = _a.limit,
      _b = _a.scanIndexForward,
      scanIndexForward = _b === void 0 ? true : _b,
      _c = _a.consistentRead,
      consistentRead = _c === void 0 ? false : _c,
      select = _a.select;
    return __awaiter(this, void 0, void 0, function () {
        ...
        switch (_f.label) {
          case 0:
            ...
            params = {
              ...
              ExpressionAttributeValues: utils_1.nullIfEmpty(
                __assign(__assign({}, filter.expressionValues || {}), keyCondition.expressionValues || {})
              ),
              ExpressionAttributeNames: utils_1.nullIfEmpty(
                __assign(__assign({}, filter.expressionNames || {}), keyCondition.expressionNames || {})
              ),
          ...
          case 1:
            (_d = _f.sent()),
              (items = _d.Items),
              (scannedCount = _d.ScannedCount),
              (_e = _d.LastEvaluatedKey),
              (resultNextToken = _e === void 0 ? null : _e);
            return [
              2 /*return*/,
              {
                items: items.map(function (item) {
                  return utils_1.unmarshall(item);
                }),
        ...
        switch (_c.label) {
          case 0:
            (key = payload.key),
              (_a = payload.update),
              (update = _a === void 0 ? {} : _a),
              (_b = payload.condition),
              (condition = _b === void 0 ? {} : _b);
            params = {
              TableName: this.tableName,
              Key: key,
              ...
              ExpressionAttributeNames: utils_1.nullIfEmpty(
                __assign(__assign({}, condition.expressionNames || {}), update.expressionNames || {})
              ),
              ExpressionAttributeValues: utils_1.nullIfEmpty(
                __assign(__assign({}, condition.expressionValues || {}), update.expressionValues || {})
              ),
            };
        ...
        switch (_d.label) {
          case 0:
            (filter = payload.filter),
              (index = payload.index),
              (limit = payload.limit),
              (_a = payload.consistentRead),
              (consistentRead = _a === void 0 ? false : _a),
          ...
          case 1:
            (_b = _d.sent()),
              (items = _b.Items),
              (scannedCount = _b.ScannedCount),
              (_c = _b.LastEvaluatedKey),
              (resultNextToken = _c === void 0 ? null : _c);
            return [
              2 /*return*/,
              {
                items: items.map(function (item) {
  ...
  DynamoDBDataLoader.prototype.transactWriteItem = function (payload) {
    return __awaiter(this, void 0, void 0, function () {
      var transactItems, items;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            transactItems = payload.transactItems;
            items = this.constructTransactItem(transactItems);
            return [
              4 /*yield*/,
              this.client
                .transactWriteItems({
  ...
  DynamoDBDataLoader.prototype.transactGetItem = function (payload) {
    return __awaiter(this, void 0, void 0, function () {
      var transactItems, items, result;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            transactItems = payload.transactItems;
          ...
          case 1:
            result = _a.sent();
            // put does not return us anything useful so we need to fetch the object.
            if (!result.Responses) return [2 /*return*/, null];
            return [2 /*return*/, utils_1.unmarshall(result.Responses, false)];
        }
      });
    });
  };
  DynamoDBDataLoader.prototype.constructTransactItem = function (transactItems) {
    return transactItems.map(function (transactItem) {
      var op = transactItem['operation'];
      if (op === undefined) {
        return { Get: DynamoDBDataLoader.getItemInput(transactItem) };
      } else {
        switch (op) {
          case 'PutItem': {
            return { Put: DynamoDBDataLoader.putItemInput(transactItem) };
          }
          case 'UpdateItem': {
            return { Update: DynamoDBDataLoader.updateItemInput(transactItem) };
          }
        }
      }
    });
  };
  DynamoDBDataLoader.putItemInput = function (payload) {
  ...
  DynamoDBDataLoader.updateItemInput = function (payload) {
    var key = payload.key,
      table = payload.table,
      _a = payload.update,
      update = _a === void 0 ? {} : _a,
  ...
  DynamoDBDataLoader.getItemInput = function (payload) {
    var table = payload.table;
    return {
      TableName: table,
      Key: payload.key,
