...
class StepFunctionsOfflinePlugin {
    constructor(serverless, options) {
        ...
        this.eventFile = this.options.eventFile || this.options.e;
        ...
        this.hooks = {
            ...
            'step-functions-offline:loadEvent': this.loadEvent.bind(this),
  ...
  loadEvent() {
    if (!this.event) {
      ...
      this.eventFile = JSON.parse(this.event);
    }
  }
